...
\title{ Laurent Schwartz: Analytical Type System \\ \vspace{-0.3cm}
...
{ Формалізація математичного аналізу в системах доведення теорем досягла
  ...
  урізаних типів Сигма. Laurent вбудовує явні примітиви для числення,
  ...
  до теорем аналізу про інтеграцію Лебега, простори $L^2$ і розподіли,
  стверджуючи, що її дизайн пропонує інтуїтивний, але строгий підхід
  до аналізу, дотримуючись конструктивної точності.
